...
Security fixes are applied to the latest version on the `main` branch. `v1.0.0` is a stable personal-Mac release and is not notarized for broad distribution.
